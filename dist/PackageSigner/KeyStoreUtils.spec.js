...
const KEYSTORE_PATH = path_1.default.join(FIXTURES, 'KeyStore');
const KEY_1 = {
    address: '0x585c34f863e4064bdeFA52305E3e7c89d39F98cF',
    path: path_1.default.join(FIXTURES, 'KeyStore', 'UTC--2019-12-17T10-30-10.617174000Z--585c34f863e4064bdefa52305e3e7c89d39f98cf'),
...
const KEY_2 = {
    ...
    path: path_1.default.join(FIXTURES, 'KeyStore', 'UTC--2019-12-17T10-30-30.026422000Z--1cd1f547be181dcd53cf8fb067a159f68938bfcd'),
...
const PEM_KEY = {
    ...
    path: path_1.default.join(FIXTURES, 'Keys', 'ec-codesign-pk.pem')
};
const INVALID_KEYFILE_PATH = path_1.default.join(FIXTURES, 'KeyStore', 'INVALID_KEYFILE');
const KEYFILE_1_PATH_OUTSIDE = path_1.default.join(FIXTURES, 'Keys', 'UTC--2019-12-17T10-30-10.617174000Z--585c34f863e4064bdefa52305e3e7c89d39f98cf');
const KEYFILE_VERSION_1 = path_1.default.join(FIXTURES, 'Keys', 'UTC--2019-13-17T10-30-10.617174000Z--585c34f863e4064bdefa52305e3e7c89d39f98cf');
...
//# sourceMappingURL=KeyStoreUtils.spec.js.map