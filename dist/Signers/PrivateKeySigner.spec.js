...
describe('PrivateKeySigner', () => {
    ...
    it('is based on ethereum-js util', () => __awaiter(void 0, void 0, void 0, function* () {
        const msg = 'hello';
        ...
        chai_1.assert.equal(address.toLowerCase(), ETH_ADDRESS_1.toLowerCase());
    }));
    describe('async ecSign(msg: string) : Promise<Buffer>', function () {
        it(`signs a message string using secp256k1 ec and returns an 'rpc'-formatted string`, () => __awaiter(this, void 0, void 0, function* () {
            const msg = 'hello';
    ...
    describe('async ethSign(msg: string) : Promise<Buffer>', function () {
        it(`produces same signature as geth's eth_sign`, () => __awaiter(this, void 0, void 0, function* () {
            const { msgBuffer, privateKey, gethSignature } = TEST_CASE_1;
            const signer = new PrivateKeySigner_1.default(privateKey);
            const signature = yield signer.ethSign(msgBuffer);
            chai_1.assert.equal(('0x' + signature.toString('hex')), gethSignature);
        }));
        it(`produces same signature as metamask's sign call`, () => __awaiter(this, void 0, void 0, function* () {
            const { msgBuffer, privateKey, metamaskSignature } = TEST_CASE_1;
            const signer = new PrivateKeySigner_1.default(privateKey);
            const signature = yield signer.ethSign(msgBuffer);
            chai_1.assert.equal(('0x' + signature.toString('hex')), metamaskSignature);
        }));
        it(`produces same signature as metamask's sign call #2`, () => __awaiter(this, void 0, void 0, function* () {
            const { msgBuffer, privateKey, metamaskSignature } = TEST_CASE_2;
            const signer = new PrivateKeySigner_1.default(privateKey);
            const signature = yield signer.ethSign(msgBuffer);
            chai_1.assert.equal(('0x' + signature.toString('hex')), metamaskSignature);
        }));
        it(`produces same signature as metamask's sign call #3`, () => __awaiter(this, void 0, void 0, function* () {
            const { msgBuffer, privateKey, metamaskSignature } = TEST_CASE_2;
            const signer = new PrivateKeySigner_1.default(privateKey);
            const signature = yield signer.ethSign(msgBuffer);
            chai_1.assert.equal(('0x' + signature.toString('hex')), metamaskSignature);
...
//# sourceMappingURL=PrivateKeySigner.spec.js.map