...
const getInput = (prop, message) => __awaiter(this, void 0, void 0, function* () {
    const question = {
        type: 'input',
        name: prop,
        message
...
const getCertType = () => __awaiter(this, void 0, void 0, function* () {
...
let default_1 = class default_1 extends clime_1.Command {
    execute(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const csr = yield __1.cert.csr(subjectInfo, privateKey, options);
            const outPath = path_1.default.join(process.cwd(), `self_signed_cert_${Date.now()}.json`);
            const certData = JSON.stringify(csr, null, 2);
            fs_1.default.writeFileSync(outPath, certData);
            task_1.progress(`Certificate: \n\n${JSON.stringify(csr, null, 2)}\nwritten to ${outPath}`);
        });
    }
};
__decorate([
